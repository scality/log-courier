			...
			records := []logcourier.LogRecord{
				{
					...
					HttpURL:             "GET /test-bucket/my-file.txt HTTP/1.1",
					HttpCode:            200,
					ErrorCode:           "",
					BytesSent:           1024,
					ContentLength:       1024,
			...
			records := []logcourier.LogRecord{
				{
					BucketName:          "test-bucket",
					StartTime:           startTime,
					HttpURL:             "GET /bucket/key?versionId=123 HTTP/1.1",
			...
			records := []logcourier.LogRecord{
				{
					...
					Action:              "REST.GET.VERSIONING",
					ObjectKey:           "",
					HttpURL:             "GET /my-bucket?versioning HTTP/1.1",
					HttpCode:            200,
					ErrorCode:           "",
					BytesSent:           113,
					ContentLength:       0,
